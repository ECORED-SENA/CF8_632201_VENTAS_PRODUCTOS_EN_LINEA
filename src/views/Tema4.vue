      ...
      .col-lg-10
        AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--azul")
          ...
          .row.justify-content-center.align-items-center(titulo="Tasa de retención de clientes")
            ...
            .col-lg-7
              p.mb-0 Esta medición es muy importante para una empresa, ya que los clientes existentes, clientes fieles, le permiten a la empresa generar ventas fijas en un muy buen porcentaje frente a los clientes nuevos, además que, estadísticamente, le genera un costo adicional hacer clientes nuevos que retener clientes fieles. La capacidad que tiene un equipo de trabajo para retener clientes existentes, se debe estar actualizando constantemente frente a las necesidades cambiantes de los clientes. “para calcular la tasa de retención de clientes, aplique la siguiente fórmula: número de clientes al final del periodo menos el número de clientes nuevos adquiridos durante el periodo, sobre número de clientes al comienzo del periodo, por cien”.
